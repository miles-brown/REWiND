...
export function mapDatabaseEvent(
  ...
  return {
    ...
    timePrecision: (row.time_precision ? String(row.time_precision) : undefined) as Precision | undefined,
    ...
    dayOfWeek: row.day_of_week ? String(row.day_of_week) : deriveDayOfWeek(normalizeIsoDate(row.start_date || "")) || undefined,
